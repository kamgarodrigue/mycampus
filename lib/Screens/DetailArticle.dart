...
class DetailArticle extends StatefulWidget {
  DetailArticle({Key key, @required this.pub}) : super(key: key);
  Pub pub;
  @override
        ...
        children: [
          Container(
            ...
            child: CarouselSlider(
              ...
              items: widget.pub.image.map((imag) {
                        ...
                        child: _showDescription
                            ? Column(
                                ...
                                children: [
                                  ...
                                  widget.pub.description.length >= 100
                                      ? Container(
                                          width: widht * 0.9,
                                          child: Text(
                                            "voir plus",
                    ...
                    Column(
                      ...
                      children: List.generate(
                          ...
                          (index) => OpenContainer(
                                ...
                                openBuilder: (context, action) => DetailArticle(
                                    pub: pubProvider.listPub[index]),
                              )),
                    )
                  ],
                )),
